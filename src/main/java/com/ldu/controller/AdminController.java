...
public class AdminController {
	...
	@ResponseBody
	public String sh(@RequestParam("itemId") int id) {
	...
	/*********************************************************
	 * 商品管理 1.查找所有商品 2.查看商品 3.修改商品 4.删除商品 5.查询商品 swx
	 * 
	 **********************************************************/
	...
	/*********************************************************
	 * 订单管理 1.查找所有订单 2.查看订单 3.修改订单 4.删除订单 5.查询订单 swx
	 * 
	 **********************************************************/
	...
	/*********************************************************
	 * 钱包管理 1.查找所有钱包 2.查看钱包 3.修改钱包 4.删除钱包 5.查询钱包 swx
	 * 
	 **********************************************************/
