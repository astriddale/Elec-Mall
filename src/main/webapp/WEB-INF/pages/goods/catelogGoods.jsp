...
<div class="main-content visible-lg visible-md visible-sm">
    <!--
        ...
        描述：最新发布
    -->
    <div class="index-title" style="margin-top: 40px;">
...
<!-------------------------------------------响应式布局分割线----------------------------------------------------->
<nav class="navbar navbar-default visible-xs" style="z-index: 9999;position: fixed;margin-top: -41px">
...
<div class="swx-xs-2">
    <div class="index-title visible-xs" style="margin-top: 40px;">
        <c:if test="${empty catelog.name}"><a class="second-swx" href="">最新发布</a></c:if>
        <c:if test="${!empty catelog.name}"><a class="second-swx" href="">${catelog.name}</a></c:if>
        <hr class="hr1">
    </div>
