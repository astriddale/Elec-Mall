		...
		<div class="container" style="width: 1000px;">
			...
			<!--搜索栏-->
			 <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchGoods" method="post">
				...
				<div  class="col-sm-8" style="text-align:center;">
					...
					<option value="" selected="selected">选择电动车状态</option>
			...
			<div style="text-align: right">
				<div class="pagination">
					<ul>
						<li><a>总电动车数:${goodsGrid.total }个</a></li>
   ...
   <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel" >修改电动车信息</h4>
            </div>
            ...
            <form class="form-horizontal" id="myeditform" name="myform">
             <input type="hidden" id="id" name="id" value=""/>
				...
				<div class="form-group">
					 <label class="col-sm-4 control-label" >租金:</label>
					<div class="col-sm-8">
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel" >查看电动车信息</h4>
            </div>
            <div class="modal-body" style="height:0 auto; ">
			...
			$.ajax({
				...
				success:function(json){
					if(json){
						...
						$('#myeditform').find("select[name='form']").val(json.status);
